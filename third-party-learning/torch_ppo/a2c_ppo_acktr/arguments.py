...
def get_args():
    ...
    parser.add_argument(
        "--gail", action="store_true", default=False, help="do imitation learning with gail"
    )
    parser.add_argument(
        "--gail-experts-dir",
    ...
    parser.add_argument(
        "--gail-batch-size", type=int, default=100, help="gail batch size (default: 128)"
    )
    ...
    parser.add_argument(
        "--log-dir", default="/tmp/gym/", help="directory to save agent logs (default: /tmp/gym)"
    )
    parser.add_argument(
        "--save-dir",
    ...
    parser.add_argument("--save-name-prex", default="", help="name before pt")
    parser.add_argument(
        "--pretrained-dir", default="/trained_models/save/xxx.pt", help="location of pretrained .pt"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--model-name", default="CNNModify", help="policy model type: CNNModify, resnet"
    )
    parser.add_argument("--num_frame_stack", default=4, type=int, help="num of frame stack ")
    ## added
    parser.add_argument("--cuda_id", default=0, type=str, help="cuda id")
    parser.add_argument("--env_sub_name", default="no", type=str, help="env sub name ")
